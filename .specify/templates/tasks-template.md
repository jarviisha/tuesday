...
- [ ] TXXX [P] Documentation updates in docs.md or the relevant active feature spec artifacts
- [ ] TXXX Code cleanup and refactoring
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX [P] Additional unit tests required for changed behavior in tests/unit/
...
- Tests required for changed behavior MUST be written and FAIL before implementation
...
```bash
# Launch all tests for User Story 1 together (when behavior changes):
